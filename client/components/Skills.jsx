    ...
    return (
        ...
        <div class="container" data-aos="fade-up">
          <div class="section-title">
            ...
            <p>
              <strong>
                JavaScript (ES6+), React (Context, Hooks, Fiber, Router), D3.js,
                Redux, Node.js, Express, SQL, NoSQL, Webpack, Version Control
                (git)
              </strong>
              <br />
              Java, Python, OOP, Sass, AWS, Chrome API, CI/CD (Travis), Jest,
              Enzyme, Puppeteer, WebSocket, Mapbox, Docker
            </p>
          </div>
          ...
          <div class="row skills-content">
            <div class="col-lg-6">
              ...
              <div class="progress">
                <span class="skill">D3.js <i class="val">55%</i></span>
                <div class="progress-bar-wrap">
                  <div
                    class="progress-bar"
                    role="progressbar"
            ...
            <div class="col-lg-6">
              ...
              <div class="progress">
                <span class="skill">noSQL <i class="val">70%</i></span>
                <div class="progress-bar-wrap">
                  <div
                    class="progress-bar"
                    role="progressbar"
